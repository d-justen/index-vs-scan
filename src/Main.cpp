...
int main(int argc, char *argv[]) {
  ...
  const BenchmarkConfig config {
    ...
    },
    {
      ...
      Instruction(ColumnType::String, 0,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 1,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 2,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 3,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 4,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 5,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 6,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 7,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 8,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 9,  Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 10, Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 11, Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 12, Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 13, Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 14, Operation::LessOrEqualsIndexBitset, string_select),
      Instruction(ColumnType::String, 15, Operation::LessOrEqualsIndexBitset, string_select),
