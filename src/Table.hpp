...
class Table {
 ...
 private:
  ...
  void _fill_int_column(size_t index, uint32_t value_count, OperationType operation_type, double selectivity, uint32_t num_rows, uint32_t value);
  void _fill_string_column(size_t index, uint32_t value_count, OperationType  operation_type, double selectivity, uint32_t num_rows, uint32_t value);
